...
# copied out from
# https://github.com/goatchurchprime/jupyter_micropython_kernel/blob/master/jupyter_micropython_kernel/install.py

# sys.executable should be "python3"
kernel_json = {"argv": [sys.executable, "-m", "jupyterlab_micropython_kernel", "-f", "{connection_file}"],
